...
declare -a changefrom=(
	...
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libboost_container.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libboost_graph.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libboost_random.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libboost_regex.dylib\""
	...
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/liblapacke.3.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/liblapack.3.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libblas.3.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libopenblas.0.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libgthread-2.0.0.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libglib-2.0.0.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libpcre.1.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libpcre2-16.0.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libpcre2-8.0.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libintl.8.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libzstd.1.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/liblzma.5.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libqhull_r.8.0.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libhdf5_cpp.320.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libhdf5.320.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libsz.2.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libaec.0.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libicudata.78.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libicui18n.78.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libicuuc.78.dylib\""
	"otool -L __BIN_FILE__ | grep -o -m1 \"[-_/@.a-zA-Z0-9]*/libqcustomplot[_a-zA-Z0-9]*.dylib\""
...
declare -a changeto=(
	...
	"@executable_path/../Libraries/libboost_container.dylib"
	"@executable_path/../Libraries/libboost_graph.dylib"
	"@executable_path/../Libraries/libboost_random.dylib"
	"@executable_path/../Libraries/libboost_regex.dylib"
