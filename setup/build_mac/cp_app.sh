...
declare -a SRC_LIBS=(
	...
	"/usr/local/opt/boost/lib/libboost_graph.dylib"
	"/usr/local/opt/boost/lib/libboost_random.dylib"
	"/usr/local/opt/boost/lib/libboost_regex.dylib"
	"/usr/local/opt/boost/lib/libboost_atomic.dylib"
	"/usr/local/opt/boost/lib/libboost_iostreams.dylib"
	"/usr/local/opt/boost/lib/libboost_program_options.dylib"
	"/usr/local/opt/boost-python3/lib/libboost_python314.dylib"
	...
	"/usr/local/opt/hdf5/lib/libhdf5_cpp.320.dylib"
	"/usr/local/opt/hdf5/lib/libhdf5.320.dylib"
	"/usr/local/opt/libaec/lib/libsz.2.dylib"
	"/usr/local/opt/libaec/lib/libaec.0.dylib"
	"/usr/local/opt/icu4c@78/lib/libicudata.78.dylib"
	"/usr/local/opt/icu4c@78/lib/libicui18n.78.dylib"
	"/usr/local/opt/icu4c@78/lib/libicuuc.78.dylib"
